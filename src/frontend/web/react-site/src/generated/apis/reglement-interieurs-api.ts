...
export const ReglementInterieursApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateReglementInterieur: async (body: UpdateReglementIdBody, authorization: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ReglementInterieursApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createReglementInterieur(body: ReglementCreateBody, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20062>> {
         ...
         * @throws {RequiredError}
         */
        async deleteReglementInterieur(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20065>> {
         ...
         * @throws {RequiredError}
         */
        async reglementInterieursIndex(authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20061>> {
         ...
         * @throws {RequiredError}
         */
        async updateReglementInterieur(body: UpdateReglementIdBody, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20064>> {
         ...
         * @throws {RequiredError}
         */
        async viewReglementInterieur(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20063>> {
...
export const ReglementInterieursApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createReglementInterieur(body: ReglementCreateBody, authorization: string, options?: any): AxiosPromise<InlineResponse20062> {
         ...
         * @throws {RequiredError}
         */
        deleteReglementInterieur(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20065> {
         ...
         * @throws {RequiredError}
         */
        reglementInterieursIndex(authorization: string, options?: any): AxiosPromise<InlineResponse20061> {
         ...
         * @throws {RequiredError}
         */
        updateReglementInterieur(body: UpdateReglementIdBody, authorization: string, options?: any): AxiosPromise<InlineResponse20064> {
         ...
         * @throws {RequiredError}
         */
        viewReglementInterieur(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20063> {
...
export class ReglementInterieursApi extends BaseAPI {
     ...
     * @memberof ReglementInterieursApi
     */
    public updateReglementInterieur(body: UpdateReglementIdBody, authorization: string, options?: any) {
