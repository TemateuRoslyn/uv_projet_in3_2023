...
export const SanctionprevusApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createSanctionPrevu(libelle: string, niveauGravite: string, motif: string, dureeValidite: string, eleveId: number, convocationId: number, regleId: number, fauteId: number, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20111>> {
         ...
         * @throws {RequiredError}
         */
        async deleteSanctionPrevu(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20077>> {
         ...
         * @throws {RequiredError}
         */
        async sanctionprevusIndex(authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20074>> {
         ...
         * @throws {RequiredError}
         */
        async updateSanctionPrevu(libelle: string, niveauGravite: string, motif: string, dureeValidite: string, eleveId: number, convocationId: number, regleId: number, fauteId: number, authorization: string, sanctionprevuId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20076>> {
         ...
         * @throws {RequiredError}
         */
        async viewSanctionPrevu(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20075>> {
...
export const SanctionprevusApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createSanctionPrevu(libelle: string, niveauGravite: string, motif: string, dureeValidite: string, eleveId: number, convocationId: number, regleId: number, fauteId: number, authorization: string, options?: any): AxiosPromise<InlineResponse20111> {
         ...
         * @throws {RequiredError}
         */
        deleteSanctionPrevu(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20077> {
         ...
         * @throws {RequiredError}
         */
        sanctionprevusIndex(authorization: string, options?: any): AxiosPromise<InlineResponse20074> {
         ...
         * @throws {RequiredError}
         */
        updateSanctionPrevu(libelle: string, niveauGravite: string, motif: string, dureeValidite: string, eleveId: number, convocationId: number, regleId: number, fauteId: number, authorization: string, sanctionprevuId: number, options?: any): AxiosPromise<InlineResponse20076> {
         ...
         * @throws {RequiredError}
         */
        viewSanctionPrevu(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20075> {
