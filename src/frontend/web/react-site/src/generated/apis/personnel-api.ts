...
export const PersonnelApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createPersonnel(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, fonction: string, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2017>> {
         ...
         * @throws {RequiredError}
         */
        async deletePersonnel(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20051>> {
         ...
         * @throws {RequiredError}
         */
        async personelIndex(authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20048>> {
         ...
         * @throws {RequiredError}
         */
        async updatePersonnel(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, fonction: string, authorization: string, personnelId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20050>> {
         ...
         * @throws {RequiredError}
         */
        async viewPersonnel(authorization: string, personnelId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20049>> {
...
export const PersonnelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createPersonnel(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, fonction: string, authorization: string, options?: any): AxiosPromise<InlineResponse2017> {
         ...
         * @throws {RequiredError}
         */
        deletePersonnel(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20051> {
         ...
         * @throws {RequiredError}
         */
        personelIndex(authorization: string, options?: any): AxiosPromise<InlineResponse20048> {
         ...
         * @throws {RequiredError}
         */
        updatePersonnel(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, fonction: string, authorization: string, personnelId: number, options?: any): AxiosPromise<InlineResponse20050> {
         ...
         * @throws {RequiredError}
         */
        viewPersonnel(authorization: string, personnelId: number, options?: any): AxiosPromise<InlineResponse20049> {
