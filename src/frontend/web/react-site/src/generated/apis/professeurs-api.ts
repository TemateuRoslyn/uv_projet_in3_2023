...
export const ProfesseursApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteProfesseur(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20066>> {
         ...
         * @throws {RequiredError}
         */
        async professeursIndex(authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20063>> {
         ...
         * @throws {RequiredError}
         */
        async updateProfesseur(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, statut: string, courId: number, authorization: string, professeurId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20065>> {
         ...
         * @throws {RequiredError}
         */
        async viewProfesseur(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20064>> {
...
export const ProfesseursApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteProfesseur(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20066> {
         ...
         * @throws {RequiredError}
         */
        professeursIndex(authorization: string, options?: any): AxiosPromise<InlineResponse20063> {
         ...
         * @throws {RequiredError}
         */
        updateProfesseur(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, statut: string, courId: number, authorization: string, professeurId: number, options?: any): AxiosPromise<InlineResponse20065> {
         ...
         * @throws {RequiredError}
         */
        viewProfesseur(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20064> {
