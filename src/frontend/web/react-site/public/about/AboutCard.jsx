          ...
          <div className='reglement'>
            {/* <div className='items'>
              {homeAbout.map((val,key) => {
                return (
                  <div className='item flexSB' key={key} >
                    <div className='img'>
            ...
            <p>Le présent règlement s'applique à toutes les personnes habilitées à entrer dans le lycée. 
              ...
              du lycée.</p>
            <Heading subtitle='Article 2: Obligation générales' title='' />
            <p>Toutes les personnes habilitées à entrer dans le lycée s’engagent à respecter ce règlement intérieur. 
              Elles s’engagent également à respecter les autres règles 
              et règlements applicables dans le lycée et à adhérer à la culture du lycée.</p>
            ...
            <p>Tous les élèves et les membres du personnel du lycée doivent respecter et veiller 
              à la bonne utilisation des locaux et du matériel mis à leur disposition. </p>
            <Heading subtitle='Article 5: Utilisation des ressources en ligne' title='' />
            <p>L’accès à Internet et aux ressources en ligne est réservé aux fins
               d’études et de recherche et est strictement interdit
               d’utiliser Internet et ces ressources dans des activités illicites ou répréhensibles. </p>
            ...
            <p>Tous les membres du personnel et les étudiants du lycée doivent se respecter 
              mutuellement et éviter tout comportement inapproprié, abusif ou discriminatoire. </p>
            <Heading subtitle='Article 8: Sanctions' title='' />
            <p>Toute activité ou comportement illicite ou répréhensible 
              sera sanctionné par des mesures disciplinaires appropriées. </p>
          </div>
        </div>
      </section>
      <Awrapper />
