                    ...
                    <form className="modal-form">
                        ...
                        <div>
                            ...
                            <span className="absolute top-1/2 left-4 z-30 -translate-y-1/2">
                                ...
                                <select 
                                    ...
                                    className=" form-label form-class relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={shortName}
                                disabled
                                className="form-label form-class w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary dark:disabled:bg-black"
                            />
                        </div>
