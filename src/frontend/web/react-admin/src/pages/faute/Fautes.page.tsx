...
import DisplayFaute from './components/DisplayFaute';
...
import { AuthApi, FautesApi } from '../../generated';
...
const FautePage = () => {
  ...
  const [Faute, setFaute] = useState<Faute[]>([]);
