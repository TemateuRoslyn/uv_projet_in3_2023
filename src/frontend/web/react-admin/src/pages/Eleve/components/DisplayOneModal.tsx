          ...
          <div className="modal-body">
            ...
            <div className="profile-view">
              ...
              <div className="profile-info">
                ...
                <p className="profile-placeOfBirth">
                  Lieu de Naissance : {props.item.lieuDeNaissance}
                </p>
                <p className="profile-class">
                 classe: {props.item.classe.shortName }
                ...
                <p className="profile-solvable">
                solvable: {props.item.solvable  ? "OUI" : "NON"}
                </p>
