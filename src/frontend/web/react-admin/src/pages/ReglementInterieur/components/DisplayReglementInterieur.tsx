...
const DisplayReglementInterieur: React.FC<DisplayReglementInterieurProps> = (props) => {
    const state = useSelector((state: ReduxProps) => state);
    const [reglementInterieur, setReglementInterieur] = useState<ReglementInterieur[]>(props.reglementInterieur);
    const [reglementInterieurItem, setReglementInterieurItem] = useState<ReglementInterieur>(props?.reglementInterieur[0]);
    ...
    const processDeleteItem = () => {
        ...
        reglementInterieurApi.deleteReglementInterieur('Bearer ' + token,reglementInterieurItem.id)
            .then((response) => {  
                if (response && response.data) {                    
                    if (response.data.success === true) { 
                        ...
                        props.setDangerNotifDescription('Ce reglementInterieur a été supprimé avec succès');
