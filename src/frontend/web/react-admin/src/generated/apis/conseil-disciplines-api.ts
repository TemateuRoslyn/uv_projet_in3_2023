...
import { ConseilDisciplineUpdateBody } from '../models';
...
export const ConseilDisciplinesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ConseilDisciplineUpdateBody} body 
         * @param {string} authorization JWT token
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateConseilDiscipline: async (body: ConseilDisciplineUpdateBody, authorization: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/conseil_discipline/update`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const ConseilDisciplinesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async conseilDisciplinesIndex(authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2008>> {
         ...
         * @throws {RequiredError}
         */
        async createConseilDiscipline(dateCd: string, heureDebutCd: string, heureFinCd: string, eleveId: number, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20010>> {
         ...
         * @throws {RequiredError}
         */
        async deleteConseilDiscipline(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20012>> {
         ...
         * @throws {RequiredError}
         */
        async updateConseilDiscipline(body: ConseilDisciplineUpdateBody, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20011>> {
         ...
         * @throws {RequiredError}
         */
        async viewConseilDiscipline(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2009>> {
...
export const ConseilDisciplinesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        conseilDisciplinesIndex(authorization: string, options?: any): AxiosPromise<InlineResponse2008> {
         ...
         * @throws {RequiredError}
         */
        createConseilDiscipline(dateCd: string, heureDebutCd: string, heureFinCd: string, eleveId: number, authorization: string, options?: any): AxiosPromise<InlineResponse20010> {
         ...
         * @throws {RequiredError}
         */
        deleteConseilDiscipline(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20012> {
         ...
         * @throws {RequiredError}
         */
        updateConseilDiscipline(body: ConseilDisciplineUpdateBody, authorization: string, options?: any): AxiosPromise<InlineResponse20011> {
         ...
         * @throws {RequiredError}
         */
        viewConseilDiscipline(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse2009> {
...
export class ConseilDisciplinesApi extends BaseAPI {
     ...
     * @memberof ConseilDisciplinesApi
     */
    public updateConseilDiscipline(body: ConseilDisciplineUpdateBody, authorization: string, options?: any) {
