...
export const ConseilDisciplinesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async updateConseilDiscipline(body: UpdateConseilDisciplineIdBody, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20011>> {
...
export const ConseilDisciplinesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateConseilDiscipline(body: UpdateConseilDisciplineIdBody, authorization: string, options?: any): AxiosPromise<InlineResponse20011> {
