...
export const PersonnelApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async deletePersonnel(authorization: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20058>> {
         ...
         * @throws {RequiredError}
         */
        async personelIndex(authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20055>> {
         ...
         * @throws {RequiredError}
         */
        async updatePersonnel(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, fonction: string, authorization: string, personnelId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20057>> {
         ...
         * @throws {RequiredError}
         */
        async viewPersonnel(authorization: string, personnelId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20056>> {
...
export const PersonnelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        deletePersonnel(authorization: string, id: number, options?: any): AxiosPromise<InlineResponse20058> {
         ...
         * @throws {RequiredError}
         */
        personelIndex(authorization: string, options?: any): AxiosPromise<InlineResponse20055> {
         ...
         * @throws {RequiredError}
         */
        updatePersonnel(email: string, firstName: string, lastName: string, dateDeNaissance: string, lieuDeNaissance: string, photo: string, sexe: string, telephone: string, fonction: string, authorization: string, personnelId: number, options?: any): AxiosPromise<InlineResponse20057> {
         ...
         * @throws {RequiredError}
         */
        viewPersonnel(authorization: string, personnelId: number, options?: any): AxiosPromise<InlineResponse20056> {
