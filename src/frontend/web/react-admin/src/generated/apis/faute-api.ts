...
export const FauteApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async updatemistake(body: FauteUpdateBody, authorization: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20019>> {
...
export const FauteApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        updatemistake(body: FauteUpdateBody, authorization: string, options?: any): AxiosPromise<InlineResponse20019> {
