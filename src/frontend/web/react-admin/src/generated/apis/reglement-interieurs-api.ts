...
export const ReglementInterieursApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} authorization JWT token
         * @param {number} reglementId ID of reglement to update in this request
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const ReglementInterieursApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async updateReglementInterieur(body: UpdateReglementIdBody, authorization: string, reglementId: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20071>> {
...
export const ReglementInterieursApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateReglementInterieur(body: UpdateReglementIdBody, authorization: string, reglementId: number, options?: any): AxiosPromise<InlineResponse20071> {
