...
class FauteController extends Controller
{
     ...
     */
     ...
     {
        $fautes = Faute::has(['regle','eleve'])->with(['regle','eleve'])->get();
     ...
     */
     public function store(Request $request)
     {
         ...
         $faute->eleve = Eleve::with('faute')->find($faute->id);
         $faute->regle = Regle::with('faute')->find($faute->id);
  ...
  /**
     ...
     *         description="Success",
     *         @OA\JsonContent(
     *             @OA\Property(property="reglement", type="object", ref="#/components/schemas/Faute"),
     *         )
     *     )
     * )
     */
